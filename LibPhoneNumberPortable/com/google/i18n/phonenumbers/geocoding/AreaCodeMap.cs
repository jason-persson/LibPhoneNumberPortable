 ...
 * @author Shaopeng Jia
 */
public class AreaCodeMap : Externalizable {
  private readonly PhoneNumberUtil phoneUtil = PhoneNumberUtil.getInstance();
  private static readonly Logger LOGGER = Logger.getLogger("AreaCodeMap");

  private AreaCodeMapStorageStrategy areaCodeMapStorage;

  // @VisibleForTesting
  internal AreaCodeMapStorageStrategy getAreaCodeMapStorage() {
