 ...
 */
internal class FlyweightMapStorage : AreaCodeMapStorageStrategy {
  // Size of short and integer types in bytes.
  private static readonly int SHORT_NUM_BYTES = Short.SIZE / 8;
  private static readonly int INT_NUM_BYTES = Integer.SIZE / 8;
