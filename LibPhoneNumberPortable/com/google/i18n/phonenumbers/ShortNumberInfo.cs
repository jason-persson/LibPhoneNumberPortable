...
public class ShortNumberInfo {
  private static readonly Logger logger = Logger.getLogger("ShortNumberInfo");

  private static readonly ShortNumberInfo INSTANCE =
      new ShortNumberInfo(PhoneNumberUtil.getInstance());
  // In these countries, if extra digits are added to an emergency number, it no longer connects
  // to the emergency service.
  private static readonly Set<String> REGIONS_WHERE_EMERGENCY_NUMBERS_MUST_BE_EXACT =
      new HashSet<String>();
  static {
