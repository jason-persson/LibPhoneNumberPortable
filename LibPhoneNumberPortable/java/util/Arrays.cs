...
public class Arrays {
    ...
    internal static int binarySearch<T>(T[] array, T value)
    {
    ...
    internal static List<T> asList<T>(T[] a) where T : class
    {
        return new List<T>(a);
    }
    ...
    internal static void fill<T>(T[] array, int start, int end, T value)
    {
...
/*
    ...
    static readonly class LegacyMergeSort {
        private static readonly boolean userRequested =
    ...
    private static readonly int INSERTIONSORT_THRESHOLD = 7;
    ...
    {
        private static readonly long serialVersionUID = -2764017481108945198L;
        private readonly E[] a;
        ArrayList(E[] array) {
            if (array==null)
