...
{
sealed class ASCII {
    internal static readonly int UPPER   = 0x00000100;
    internal static readonly int LOWER   = 0x00000200;
    internal static readonly int DIGIT   = 0x00000400;
    internal static readonly int SPACE   = 0x00000800;
    internal static readonly int PUNCT   = 0x00001000;
    internal static readonly int CNTRL   = 0x00002000;
    internal static readonly int BLANK   = 0x00004000;
    internal static readonly int HEX     = 0x00008000;
    internal static readonly int UNDER   = 0x00010000;
    internal static readonly int ASCIi   = 0x0000FF00;
    ...
    private static readonly int[] ctype = new int[] {
        CNTRL,                  /* 00 (NUL) */
        CNTRL,                  /* 01 (SOH) */
        CNTRL,                  /* 02 (STX) */
        CNTRL,                  /* 03 (ETX) */
    ...
    internal static boolean isType(int ch, int type) {
        return (getType(ch) & type) != 0;
    }
    internal static boolean isAscii(int ch) {
    ...
    internal static boolean isGraph(int ch) {
        return isType(ch, GRAPH);
    }
    internal static boolean isPrint(int ch) {
        return ((ch-0x20)|(0x7E-ch)) >= 0;
    }
    internal static boolean isPunct(int ch) {
        return isType(ch, PUNCT);
    }
    internal static boolean isSpace(int ch) {
        return isType(ch, SPACE);
    }
    internal static boolean isHexDigit(int ch) {
        return isType(ch, HEX);
    }
    internal static boolean isOctDigit(int ch) {
        return ((ch-'0')|('7'-ch)) >= 0;
    }
    internal static boolean isCntrl(int ch) {
        return isType(ch, CNTRL);
    }
    internal static boolean isLower(int ch) {
        return ((ch-'a')|('z'-ch)) >= 0;
    }
    internal static boolean isUpper(int ch) {
        return ((ch-'A')|('Z'-ch)) >= 0;
    }
    internal static boolean isWord(int ch) {
