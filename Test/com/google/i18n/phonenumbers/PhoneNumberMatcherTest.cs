 ...
 */
[TestClass] public class PhoneNumberMatcherTest : TestMetadataTestCase {

  [TestMethod] public void testContainsMoreThanOneSlashInNationalNumber() {
  ...
  [TestMethod] public void testFindNationalNumber() {
  ...
  [TestMethod] public void testFindWithInternationalPrefixes() {
  ...
  [TestMethod] public void testFindWithLeadingZero() {
  ...
  [TestMethod] public void testFindNationalNumberArgentina() {
  ...
  [TestMethod] public void testFindWithXInNumber() {
  ...
  [TestMethod] public void testFindNumbersMexico() {
  ...
  [TestMethod] public void testFindNumbersWithPlusWithNoRegion() {
  ...
  [TestMethod] public void testFindExtensions() {
  ...
  [TestMethod] public void testFindInterspersedWithSpace() {
   ...
   */
  [TestMethod] public void testIntermediateParsePositions() {
  ...
  [TestMethod] public void testMatchWithSurroundingZipcodes() {
  ...
  [TestMethod] public void testIsLatinLetter() {
  ...
  [TestMethod] public void testMatchesWithSurroundingLatinChars() {
  ...
  [TestMethod] public void testMoneyNotSeenAsPhoneNumber() {
    ArrayList<NumberContext> possibleOnlyContexts = new ArrayList<NumberContext>();
  ...
  [TestMethod] public void testPercentageNotSeenAsPhoneNumber() {
    ArrayList<NumberContext> possibleOnlyContexts = new ArrayList<NumberContext>();
    possibleOnlyContexts.add(new NumberContext("", "%"));
  ...
  [TestMethod] public void testPhoneNumberWithLeadingOrTrailingMoneyMatches() {
  ...
  [TestMethod] public void testMatchesWithSurroundingLatinCharsAndLeadingPunctuation() {
  ...
  [TestMethod] public void testMatchesWithSurroundingChineseChars() {
    ArrayList<NumberContext> validContexts = new ArrayList<NumberContext>();
  ...
  [TestMethod] public void testMatchesWithSurroundingPunctuation() {
    ArrayList<NumberContext> validContexts = new ArrayList<NumberContext>();
  ...
  [TestMethod] public void testMatchesMultiplePhoneNumbersSeparatedByPhoneNumberPunctuation() {
  ...
  [TestMethod] public void testDoesNotMatchMultiplePhoneNumbersSeparatedWithNoWhiteSpace() {
  ...
  [TestMethod] public void testMatchesWithPossibleLeniency() {
  ...
  [TestMethod] public void testNonMatchesWithPossibleLeniency() {
    List<NumberTest> testCases = new ArrayList<NumberTest>();
    testCases.addAll(Arrays.asList(IMPOSSIBLE_CASES));
    doTestNumberNonMatchesForLeniency(testCases, Leniency.POSSIBLE);
  }

  [TestMethod] public void testMatchesWithValidLeniency() {
    List<NumberTest> testCases = new ArrayList<NumberTest>();
    testCases.addAll(Arrays.asList(STRICT_GROUPING_CASES));
    testCases.addAll(Arrays.asList(EXACT_GROUPING_CASES));
    testCases.addAll(Arrays.asList(VALID_CASES));
  ...
  [TestMethod] public void testNonMatchesWithValidLeniency() {
    List<NumberTest> testCases = new ArrayList<NumberTest>();
    testCases.addAll(Arrays.asList(IMPOSSIBLE_CASES));
    testCases.addAll(Arrays.asList(POSSIBLE_ONLY_CASES));
  ...
  [TestMethod] public void testMatchesWithStrictGroupingLeniency() {
    List<NumberTest> testCases = new ArrayList<NumberTest>();
    testCases.addAll(Arrays.asList(STRICT_GROUPING_CASES));
    testCases.addAll(Arrays.asList(EXACT_GROUPING_CASES));
  ...
  [TestMethod] public void testNonMatchesWithStrictGroupLeniency() {
    List<NumberTest> testCases = new ArrayList<NumberTest>();
    testCases.addAll(Arrays.asList(IMPOSSIBLE_CASES));
    testCases.addAll(Arrays.asList(POSSIBLE_ONLY_CASES));
    testCases.addAll(Arrays.asList(VALID_CASES));
  ...
  [TestMethod] public void testMatchesWithExactGroupingLeniency() {
    List<NumberTest> testCases = new ArrayList<NumberTest>();
    testCases.addAll(Arrays.asList(EXACT_GROUPING_CASES));
    doTestNumberMatchesForLeniency(testCases, Leniency.EXACT_GROUPING);
  }

  [TestMethod] public void testNonMatchesExactGroupLeniency() {
    List<NumberTest> testCases = new ArrayList<NumberTest>();
    testCases.addAll(Arrays.asList(IMPOSSIBLE_CASES));
    testCases.addAll(Arrays.asList(POSSIBLE_ONLY_CASES));
    testCases.addAll(Arrays.asList(VALID_CASES));
  ...
  [TestMethod] public void testNonMatchingBracketsAreInvalid() {
  ...
  [TestMethod] public void testMaxMatchesInvalid() {
  ...
  [TestMethod] public void testMaxMatchesMixed() {
  ...
  [TestMethod] public void testNonPlusPrefixedNumbersNotFoundForInvalidRegion() {
  ...
  [TestMethod] public void testEmptyIteration() {
  ...
  [TestMethod] public void testSingleIteration() {
  ...
  [TestMethod] public void testDoubleIteration() {
    Iterable<PhoneNumberMatch> iterable =
   ...
   */
  [TestMethod] public void testRemovalNotSupported() {
    Iterable<PhoneNumberMatch> iterable = phoneUtil.findNumbers("+14156667777", RegionCode.ZZ);
