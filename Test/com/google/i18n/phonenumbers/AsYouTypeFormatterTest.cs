 ...
 * @author Shaopeng Jia
 */
[TestClass] public class AsYouTypeFormatterTest : TestMetadataTestCase {

  [TestMethod] public void testInvalidRegion() {
  ...
  [TestMethod] public void testInvalidPlusSign() {
    AsYouTypeFormatter formatter = phoneUtil.getAsYouTypeFormatter(RegionCode.ZZ);
    assertEquals("+", formatter.inputDigit('+'));
    assertEquals("+4", formatter.inputDigit('4'));
    assertEquals("+48 ", formatter.inputDigit('8'));
  ...
  [TestMethod] public void testTooLongNumberMatchingMultipleLeadingDigits() {
  ...
  [TestMethod] public void testCountryWithSpaceInNationalPrefixFormattingRule() {
  ...
  [TestMethod] public void testCountryWithSpaceInNationalPrefixFormattingRuleAndLongNdd() {
    AsYouTypeFormatter formatter = phoneUtil.getAsYouTypeFormatter(RegionCode.BY);
  ...
  [TestMethod] public void testAYTFUS() {
  ...
  [TestMethod] public void testAYTFUSFullWidthCharacters() {
    AsYouTypeFormatter formatter = phoneUtil.getAsYouTypeFormatter(RegionCode.US);
  ...
  [TestMethod] public void testAYTFUSMobileShortCode() {
    AsYouTypeFormatter formatter = phoneUtil.getAsYouTypeFormatter(RegionCode.US);
    assertEquals("*", formatter.inputDigit('*'));
    assertEquals("*1", formatter.inputDigit('1'));
  ...
  [TestMethod] public void testAYTFUSVanityNumber() {
    AsYouTypeFormatter formatter = phoneUtil.getAsYouTypeFormatter(RegionCode.US);
    assertEquals("8", formatter.inputDigit('8'));
  ...
  [TestMethod] public void testAYTFAndRememberPositionUS() {
    AsYouTypeFormatter formatter = phoneUtil.getAsYouTypeFormatter(RegionCode.US);
  ...
  [TestMethod] public void testAYTFGBFixedLine() {
  ...
  [TestMethod] public void testAYTFGBTollFree() {
    AsYouTypeFormatter formatter = phoneUtil.getAsYouTypeFormatter(RegionCode.GB);
    assertEquals("0", formatter.inputDigit('0'));
  ...
  [TestMethod] public void testAYTFGBPremiumRate() {
    AsYouTypeFormatter formatter = phoneUtil.getAsYouTypeFormatter(RegionCode.GB);
    assertEquals("0", formatter.inputDigit('0'));
  ...
  [TestMethod] public void testAYTFNZMobile() {
  ...
  [TestMethod] public void testAYTFDE() {
  ...
  [TestMethod] public void testAYTFAR() {
  ...
  [TestMethod] public void testAYTFARMobile() {
    AsYouTypeFormatter formatter = phoneUtil.getAsYouTypeFormatter(RegionCode.AR);
    assertEquals("+", formatter.inputDigit('+'));
  ...
  [TestMethod] public void testAYTFKR() {
    // +82 51 234 5678
  ...
  [TestMethod] public void testAYTF_MX() {
  ...
  [TestMethod] public void testAYTF_International_Toll_Free() {
    AsYouTypeFormatter formatter = phoneUtil.getAsYouTypeFormatter(RegionCode.US);
    // +800 1234 5678
    assertEquals("+", formatter.inputDigit('+'));
    assertEquals("+8", formatter.inputDigit('8'));
  ...
  [TestMethod] public void testAYTFMultipleLeadingDigitPatterns() {
    // +81 50 2345 6789
  ...
  [TestMethod] public void testAYTFLongIDD_AU() {
  ...
  [TestMethod] public void testAYTFLongIDD_KR() {
    AsYouTypeFormatter formatter = phoneUtil.getAsYouTypeFormatter(RegionCode.KR);
  ...
  [TestMethod] public void testAYTFLongNDD_KR() {
    AsYouTypeFormatter formatter = phoneUtil.getAsYouTypeFormatter(RegionCode.KR);
    // 08811-9876-7890
    assertEquals("0", formatter.inputDigit('0'));
    assertEquals("08", formatter.inputDigit('8'));
  ...
  [TestMethod] public void testAYTFLongNDD_SG() {
  ...
  [TestMethod] public void testAYTFShortNumberFormattingFix_AU() {
  ...
  [TestMethod] public void testAYTFShortNumberFormattingFix_KR() {
  ...
  [TestMethod] public void testAYTFShortNumberFormattingFix_MX() {
  ...
  [TestMethod] public void testAYTFNoNationalPrefix() {
  ...
  [TestMethod] public void testAYTFNoNationalPrefixFormattingRule() {
  ...
  [TestMethod] public void testAYTFShortNumberFormattingFix_US() {
