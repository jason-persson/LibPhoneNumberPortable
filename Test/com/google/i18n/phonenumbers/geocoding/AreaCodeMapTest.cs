 ...
 */
[TestClass]
public class AreaCodeMapTest : TestCase {
  ...
  [TestMethod] public void testGetSmallerMapStorageChoosesDefaultImpl() {
    AreaCodeMapStorageStrategy mapStorage =
        new AreaCodeMap().getSmallerMapStorage(createDefaultStorageMapCandidate());
    assertFalse(mapStorage is FlyweightMapStorage);
  }
  ...
  [TestMethod] public void testLookupInvalidNumber_US() {
  ...
  [TestMethod] public void testReadWriteExternalWithDefaultStrategy() {
    AreaCodeMap localAreaCodeMap = new AreaCodeMap();
    localAreaCodeMap.readAreaCodeMap(createDefaultStorageMapCandidate());
    assertFalse(localAreaCodeMap.getAreaCodeMapStorage() is FlyweightMapStorage);
