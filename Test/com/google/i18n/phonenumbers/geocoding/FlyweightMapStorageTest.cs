 ...
 */
[TestClass]
public class FlyweightMapStorageTest : TestCase {
  private static readonly SortedMap<Integer, String> areaCodeMap;
  static FlyweightMapStorageTest() {
  ...
  [TestMethod] public void testReadFromSortedMap() {
  ...
  [TestMethod] public void testReadFromSortedMapSupportsEmptyDescription() {
